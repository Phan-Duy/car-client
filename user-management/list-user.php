...
<div class="container">
   ...
   <div class="align-items-center mb-5">
      <a href="../car-management/list-car.php" class="btn btn-secondary me-3 mb-1">Quản lý xe</a>
      <a href="./list-user.php" class="btn btn-primary mb-1">Quản lý khách hàng</a>
      <a href="./form-user.php" class="btn btn-success my-3 d-inline-flex align-items-center justify-content-center float-end mt-4">
         ...
         <tbody>
            <?php foreach ($datas as $data) : ?>
               <tr>
                  ...
                  <td><?= $data['email'] ?></td>
                  <td><?= $data['birthDay'] ?></td>
                  <td><span class="badge bg-<?= $data['role'] === 'customer' ? 'success' : 'danger' ?>"><?= $data['role'] ?></span> 
                  </td>
                  <td>
